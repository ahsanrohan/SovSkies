...
level_map4 = pyglet.resource.image("gainesville_background.png")
level_map3 = pyglet.resource.image("water_background.png")
level_map2 = pyglet.resource.image("road_background.png")
level_map1 = pyglet.resource.image("level_background.png")
center_image(level_map1)
center_image(level_map2)
center_image(level_map3)
center_image(level_map4)
